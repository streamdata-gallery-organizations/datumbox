...
paths:
  ...
  /LanguageDetection.json:
    post:
      ...
      x-api-path-slug: languagedetectionjson-post
      parameters:
      - in: formData
        name: text
        description: The text that you want to analyze
  ...
  /ReadabilityAssessment.json:
    post:
      ...
      x-api-path-slug: readabilityassessmentjson-post
      parameters:
      - in: formData
        name: text
        description: The text that you want to analyze
  ...
  /TextExtraction.json:
    post:
      ...
      x-api-path-slug: textextractionjson-post
      parameters:
      - in: formData
        name: text
  ...
  /TopicClassification.json:
    post:
      ...
      x-api-path-slug: topicclassificationjson-post
      parameters:
      - in: formData
        name: text
        description: The text that you want to analyze
